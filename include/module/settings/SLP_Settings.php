...
class SLP_Settings extends SLP_Base_ReactObject {
	 ...
	 *      'section'   => string   text for section heading to put the setting in
	 *      'label'     => string   text that precedes the input
	 *      'setting'   => string   name of the setting (input ID)
	 *      'type'      => string   type of interface element ('checkbox'|'dropdown'|'subheader'|'submit'|'textarea')
	 *      'show_label'=> boolean  set to true to show the label (default: true)
	 *      'custom'        => string   the custom HTML output to render
...
//		if ( ! $this->slplus->SmartOptions->shouldAddToSettingsTab( $option ) ) {
//			return;
//		}
