...
if ( ! class_exists( 'SLP_SmartOptions' ) ) {
	...
	class SLP_SmartOptions extends SLPlus_BaseClass_Object {
		...
		public $active_style_css;
		public $add_tel_to_phone;
		public $address_placeholder;
		public $admin_notice_dismissed;
		public $ajax_orderby_catcount;
		public $append_to_search;
		public $bubblelayout;
		public $default_country;
		public $default_icons;
		public $delete_history_before_this_date;
		public $distance_unit;
		public $dropdown_style;
		public $email_link_format;
		public $first_entry_for_radius_selector;
		public $force_load_js;
		public $google_geocode_key;
		public $google_map_style;
		public $google_server_key;
		public $has_been_setup = false;
		public $hide_address_entry;
		public $hide_bubble;
		public $hide_distance;
		public $hide_empty;
		public $hide_map;
		public $hide_radius_selector;
		public $hide_search_form;
		public $immediately_show_locations;
		public $initial_radius;
		public $initial_results_returned;
		public $instructions;
		public $invalid_query_message;
		public $label_category;
		public $label_directions;
		public $label_email;
		public $label_fax;
		public $label_for_find_button;
		public $label_for_map_toggle;
		public $label_for_name;
		public $label_hours;
		public $label_image;
		public $label_phone;
		public $label_radius;
		...
		public $last_geocoded_location;
		public $layout;
		public $loading_indicator;
		public $log_import_messages;
		public $log_schedule_messages;
		public $map_center;
		public $map_center_lat;
		public $map_center_lng;
		public $map_controls_subheader;
		public $map_end_icon;
		public $map_height;
		public $map_height_units;
		public $map_home_icon;
		public $map_initial_display;
		public $map_options_mapTypeControl;
		public $map_options_scaleControl;
		public $map_type;
		public $map_width;
		public $map_width_units;
		public $maplayout;
		public $max_results_returned;
		public $message_bad_address;
		public $message_no_results;
		public $name_placeholder;
		public $no_autozoom;
		public $no_homeicon_at_start;
		public $pages_directory_entry_css_class;
		public $pages_directory_wrapper_css_class;
		public $permalink_flush_needed;
		public $premium_subscription_id;
		public $premium_user_id;
		public $radii;
		public $remove_credits;
		public $reporting_enabled;
		public $resultslayout;
		public $results_box_title;
		public $search_appearance_category_header;
		public $search_appearance_tag_header;
		public $search_box_title;
		public $search_by_name;
		public $searchlayout;
		public $show_cats_on_search;
		public $show_country;
		public $show_hours;
		public $show_icon_array;
		public $show_legend_text;
		public $show_maptoggle;
		public $show_option_all;
		public $starting_image;
		public $style;
		public $style_id;
		public $tag_autosubmit;
		public $tag_dropdown_first_entry;
		public $tag_label;
		public $tag_output_processing;
		public $tag_selections;
		public $tag_selector;
		public $theme;
		public $url_allow_address;
		public $url_control_description;
		public $use_contact_fields;
		public $use_nonces;
		public $use_pages;
		public $use_sensor;
		public $zoom_level;
		...
		// Private -- should use setter/getter
		private $allow_limit_in_url;
		private $allow_location_in_url;
		private $allow_tag_in_url;
		private $block_ip_limit;
		private $block_ip_period;
		private $block_ip_release_after;
		private $boundaries_influence_type;
		private $bubble_footnote;
		private $clusters_enabled;
		private $cluster_gridsize;
		private $cluster_minimum;
		private $first_entry_for_zip_selector;
		private $ip_whitelist;
		private $label_for_zip_selector;
		private $loading_indicator_color;
		private $loading_indicator_location;
		private $map_appearance_cluster_header;
		private $map_marker_tooltip;
		private $map_options_clickableIcons;
		private $map_option_fullscreenControl;
		private $map_option_hide_streetview;
		private $map_option_zoomControl;
		private $no_results_interface;
		private $no_results_gf_id;
		private $no_results_gf_landing_page;
		private $pagination_enabled;
		private $phone_extension_delimiter;
		private $results_click_animate_marker;
		private $results_click_label_marker;
		private $results_click_map_movement;
		private $results_click_marker_icon;
		private $results_click_marker_icon_behavior;
		private $results_header;
		private $results_header_1;
		private $results_header_2;
		private $results_header_3;
		private $results_header_4;
		private $results_no_wrapper;
		private $schedule_for_geocoding;
		private $schedule_for_initial_distance;
		private $search_on_map_move;
		private $search_box_subtitle;
		private $use_territory_bounds;
		private $zip_selector;
		...
		/**
		 * Check if a property should be added to the settings tab.
		 *
		 * TODO Added in recent release - may not be needed.
		 *
		 * @param string $property The property to check.
		 *
		 * @return bool Returns true if property exists, is not null, and has add to settings tab set to true
		 */
		public function shouldAddToSettingsTab( $property ) {
			if ( is_null( $property ) ) {
				return false;
			}
			if ( ! $this->exists_and_active( $property ) ) {
				return false;
			}

			return $this->$property->add_to_settings_tab;
		}
...
ACTIVE_STYLE_CSS
		 ...
		 *
		 * @return bool Returns true if the property exists and is not null, false otherwise.
		 */
		public function exists_and_active( $property ) {
			return
				(
...
SEARCHLAYOUT
		...
		public function get_options() {
			// TODO: probably  need to replace the second param with array( SLP_SmartOptions::get_instance(), 'only_smart_options' )
		 ...
		 * @param $property
		 *
		 * @return string|null type as a string (i.e. "checkbox") or null if property does not exist.
		 */
		public function get_TypeOf( $property ) {
			if ( ! $this->exists_and_active( $property ) ) {
				return null;
			}
		 ...
		 * @return mixed|null
		 */
		public function get_ValueOf( $property ) {
			if ( ! $this->exists_and_active( $property ) ) {
				return null;
			}
		 ...
		 */
		public function is_false( $property ) {
			return ! $this->is_true( $property );
		}
		...
		private function set_current_checkboxes( $admin_page ) {
			if ( empty( $this->current_checkboxes ) ) {
				...
				foreach ( $this->page_options[ $admin_page ] as $property ) {
					if ( $this->get_TypeOf( $property ) === 'checkbox' ) {
		...
		private function set_the_val( $value, $key, &$option_array, $is_smart_option, $valid_legacy_option ) {
			if ( $is_smart_option && is_object( $this->{$key} ) ) {
				...
				if ( $this->get_TypeOf( $key ) === 'textarea' ) {
					$value = stripslashes( $value );
				} elseif ( $this->get_TypeOf( $key ) === 'checkbox' ) {
		...
		private function set_valid_option( $val, $key, $which_option ) {
			...
			// If the $key is a smart option, make sure the option array (options / options_nojs) matches the JS Setting.
			$is_smart_option = property_exists( $this, $key );
			if ( $is_smart_option ) {
				if ( $valid_legacy_option ) {
					if ( ! is_null( $this->slplus->SmartOptions->{$key} ) ) {
