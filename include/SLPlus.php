...
if ( ! class_exists( 'SLPlus' ) ) {
	...
	class SLPlus extends SLP_Object_With_Objects {
		...
		public $AjaxHandler;                            // TODO: remove when all things use SLP_AJAX::get_instance()
		public $AJAX;                                   // TODO: remove when all things use SLP_AJAX::get_instance() (EXP, POW, PREM)
		public $ajax;                                   // TODO: remove when all things use SLP_AJAX::get_instance() (PREM)
		...
		function createobject_AJAX() {
			if ( ! isset( $this->AJAX ) ) {
				$this->AJAX = $this->AjaxHandler = $this->ajax = SLP_AJAX::get_instance();
			}
		}
